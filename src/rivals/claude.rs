...
impl ClaudeFft {
    pub fn new() -> Self {
        ...
        let pipeline_r4 = compile_wgsl(CLAUDE_R4_WGSL, "claude_r4");
        let pipeline_r2 = compile_wgsl(CLAUDE_R2_WGSL, "claude_r2");
